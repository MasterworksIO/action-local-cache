...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const loglevel_1 = __importDefault(__webpack_require__(63));
...
const getVars_1 = __webpack_require__(997);
const log_1 = __importDefault(__webpack_require__(853));
async function post() {
    try {
        const { cacheDir, targetPath, cachePath } = getVars_1.getVars();
        await io_1.mkdirP(cacheDir);
        await io_1.mv(targetPath, cachePath, { force: true });
    }
    catch (error) {
